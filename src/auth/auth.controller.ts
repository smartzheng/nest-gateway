...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description: '通过 code 获取`access_token` code:https://open.feishu.cn/open-apis/authen/v1/index?app_id=cli_a3f0a3f03e38d00d&redirect_uri=http%3A%2F%2F127.0.0.1%3A8080%2Fauth',
  })
